package com.lily.common.exception;

import cn.hutool.core.util.StrUtil;
import com.lily.common.exception.error.ErrorCodeInterface;
 ...
 * @version 1.0
 */
@EqualsAndHashCode(callSuper = true)//@Data已包含 @EqualsAndHashCode：若同时使用 @Data和 @EqualsAndHashCode，后者的配置会覆盖前者。（此处显式使用 @EqualsAndHashCode是为了设置 callSuper=true，因为 @Data默认 callSuper=false）
@Slf4j
@Data//@Data不会生成全参构造函数，需配合 @AllArgsConstructor和 @NoArgsConstructor按需添加。
