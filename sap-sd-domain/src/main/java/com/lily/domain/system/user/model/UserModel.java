package com.lily.domain.system.user.model;
...
import com.lily.domain.system.dept.model.DeptModelFactory;
import com.lily.domain.system.post.model.PostModelFactory;
import com.lily.domain.system.role.model.RoleModelFactory;
...
public class UserModel extends SysUserEntity {
    ...
    public boolean updateById() {
        if (this.getIsAdmin() && SapSdConfig.isDemoEnabled()) {
