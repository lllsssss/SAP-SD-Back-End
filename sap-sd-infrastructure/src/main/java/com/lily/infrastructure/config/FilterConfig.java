...
import com.lily.infrastructure.exception.GlobalExceptionFilter;
import com.lily.infrastructure.filter.TestFilter;
import com.lily.infrastructure.filter.TraceIdFilter;
...
public class FilterConfig {
    ...
    @Value("${sap-sd.traceRequestIdKey}")
